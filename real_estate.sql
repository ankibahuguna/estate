...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2015 at 03:12 PM
...
('m000000_000000_base', 1421753935);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `firstname` varchar(98) NOT NULL,
  `lastname` varchar(98) NOT NULL,
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`id`) REFERENCES `user_role` (`role_id`) ON DELETE CASCADE ON UPDATE CASCADE;
